# Generated by Django 5.2.10 on 2026-01-29 22:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Enter the book's writing language (e.g. English, French, Japanese, etc.)", max_length=20, unique=True)),
            ],
            options={
