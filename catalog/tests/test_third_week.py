...
class ThirdWeekTests(TestCase):
    ...
    def test_tests_models_exist(self):
        ...
        self.assertIn(
            "test_object_name_is_last_name_comma_first_name", dir(c1)
        )
    ...
    def test_tests_views_exist(self):
        ...
        from catalog.tests.test_views import (
            LoanedBookInstancesByUserListViewTest as c4,
        )
        ...
        self.assertIn(
            "test_forbidden_if_logged_in_but_not_correct_permission", dir(c5)
        )
        ...
        self.assertIn(
            "test_redirects_to_all_borrowed_book_list_on_success", dir(c5)
        )
    ...
    def test_challenge_one(self):
        ...
        self.assertIn(
            "test_forbidden_if_logged_in_but_not_correct_permission", dir(c6)
        )
        self.assertIn("test_logged_in_with_permission", dir(c6))
        self.assertIn("test_uses_correct_template", dir(c6))
        self.assertIn(
            "test_form_date_of_death_initially_set_to_expected_date", dir(c6)
        )
