...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        # Check that it lets us login - this is our book and we have the
        # right permissions.
        self.assertEqual(response.status_code, 200)
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_author_detail_on_success(self):
        ...
        # Get the author that was created
        author = Author.objects.get(first_name="John", last_name="Smith")

        self.assertRedirects(response, author.get_absolute_url())

    def test_error_if_first_name_missing(self):
        self.client.login(username="test_user1", password="some_password1")
        response = self.client.post(
            reverse("author-create"),
            {
